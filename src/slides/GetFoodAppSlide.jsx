...
const GetFoodAppSlide = () => {
  return (
    <div
      className='bg-white p-6  md:p-12 lg:p-24 flex flex-col justify-between  bg-cover'
    ...
    >
      <div className='flex w-full ml-2 justify-start items-end  flex-col'>
        ...
        <div className='flex   flex-col'>
          <h1 className='text-[20px] font-[700] lg:text-[42px] '>Get<span className='text-red-600'>FoodKart</span>App</h1>
          <h3 className=' text-[12px] mb-3 font-[600] lg:text-[24px]'>Get delicacies delivered to <br /> your doorstep in minutes</h3>
        </div>
        <div className='flex  '>
          <img src={footerplay} alt="" className='w-[80px] lg:w-[170px] ' />
          <img src={footerapple} alt="" className='w-[80px] lg:w-[170px]' />
        </div>
      </div>
