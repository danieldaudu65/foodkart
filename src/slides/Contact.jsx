        ...
        <div id='contact' className='flex  bg-[#EDEDED] p-8 lg:p-20 justify-center items-center flex-col'>
            ...
            <div className='flex w-full gap-6 flex-col lg:flex-row justify-start   '>
                ...
                <div className='lg:w-1/2   w-full '>
                    <form action="" className='flex mt-4 gap-4 lg:gap-6 flex-col   w-full'>
                        ...
                        <textarea type="text" placeholder='Your Message' className='bg-white w-full px-4 lg:h-[250px] outline-0 h-[100px]   py-4' />
