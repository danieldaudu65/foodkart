...
const testimonials = [
    {
        name: 'Ola John',
        type: "Vendor",
        testimony: "FoodKart has been a game-changer for our business. The platform is incredibly user-friendly, and the logistics support means we can serve more customers efficiently. "
    },
    {
        name: 'Divine Mikcy',
        type: "Customer",
        testimony: "I love the convenience FoodKart offers. From ordering to delivery, the process is smooth, and the food always arrives fresh. It’s made enjoying restaurant-quality meals at home so much easier "
    },
    {
        name: 'Bob Ike',
        type: "Vendor",
        testimony: "Partnering with FoodKart has been one of the best decisions for our restaurant. The ease of managing orders and the prompt delivery service have significantly improved our customer satisfaction. "
    },
    {
        name: 'Igness Olanike',
        type: "Customer",
        testimony: "FoodKart delivers on its promise of fast, reliable service. The app is easy to use, and I can always count on my meals arriving on time. It’s become my go-to for ordering food. "
    },
    {
        name: 'Rolland Mika',
        type: "Vendor",
        testimony: "FoodKart’s logistics service has allowed us to focus more on creating great dishes while they handle the delivery. It’s a win-win for us and our customers, who are loving the fast service. "
    },
    {
        name: 'Kola ademide',
        type: "Customer",
        testimony: "With FoodKart, I can explore a variety of cuisines without leaving my house. The delivery is always quick, and the food quality is top-notch. Highly recommend it! "
    },
    {
        name: "Oluchi iri",
        type: "Vendor",
        testimony: "FoodKart has streamlined our operations. Managing orders is a breeze, and their reliable delivery service means our customers get their meals hot and on time. "
    },
    {
        name: 'Mike bami',
        type: "Cusomter",
        testimony: "FoodKart makes it so easy to order from my favorite restaurants. The quick delivery and wide selection have made it my favorite food app. "
    },
    {
        name: 'Nike Balomiya',
        type: "Vendor",
        testimony: "Since joining FoodKart, our customer base has grown significantly. The platform's efficiency in handling orders and deliveries is unmatched, making it a valuable partner for our business. "
    },
    {
        name: 'Osinachi Collins',
        type: "Customer",
        testimony: "FoodKart’s service is impeccable. The app is intuitive, and the delivery is impressively fast. It’s my top choice whenever I’m craving something delicious. "
    }
]
